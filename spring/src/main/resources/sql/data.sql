...
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('종잡을 수 없는 흐름에 다들 소름', '무한도전 양세형 소름', 102, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('요만큼도 없다', '무한도전 유재석 밈', 103, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('속이 속이 아니잖아요...', '무한도전 유재석 밈', 104, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('사이버머니 조심해요', '무한도전 유재석 밈', 105, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('재수 없으니까 가만히 좀', '무한도전 박명수 밈', 106, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('입 좀 다물고 기다리시죠?', '무한도전 유재석 밈', 107, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('조용히 하지 못할까 이 요망한 것!', '무한도전 유재석 밈', 108, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('좀 이해해주십시오! 화내서 미안합니다', '무한도전 유재석 밈', 109, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('사기꾼이에요?', '무한도전 유재석 밈', 110, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('세월을 우리만 맞은 듯', '무한도전 유재석 밈', 110, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('두 개를 가질 수는 없겠더라고...', '무한도전 유재석 밈', 111, 5, now());
INSERT INTO meme(name, description, view_count, share_count, created_date) VALUES('일이 많아!', '무한도전 유재석 밈', 112, 5, now());
